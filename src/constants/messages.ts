export const pageMessage = `In which page did you pull your last 5⭑? `
export const wishMessage = `In which spot is that 5⭑ on that page? `
export const currNumOfWishes = `You've done $1 wishes`
